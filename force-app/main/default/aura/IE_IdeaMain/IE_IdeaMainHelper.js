  ...
  getIdeaPageInfo: function(cmp) {
    ...
    action.setCallback(this, function(response) {
      ...
      if (recordId && String(recordId).trim() != '') {
        ...
        const sortListCommentList = [{ label: $A.get('$Label.c.IE_Sort_Value_New_Order'), value: $A.get('$Label.c.IE_Sort_Value_New_Order') }, { label: $A.get('$Label.c.IE_Sort_Value_Oldest_First'), value: $A.get('$Label.c.IE_Sort_Value_Oldest_First') }];
        ...
        /*
				...
				*/
        const sortList = [{ label: $A.get('$Label.c.IE_Sort_Value_Trend'), value: 'Trend' }, { label: $A.get('$Label.c.IE_Sort_Value_Latest'), value: 'Latest' }, { label: $A.get('$Label.c.IE_Sort_Value_Closed'), value: 'Closed' }];
